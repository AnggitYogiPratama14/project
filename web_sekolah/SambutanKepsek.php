      ...
      <div class="main">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">SAMBUTAN KEPALA SEKOLAH</h2>
              </div>
            </div>
          </div>
        </section>
        <section class="module">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <h3 class="font-alt">Sambutan Kepala Sekolah</h3><br>
                <h5 class="font-alt">Assalamuálaikum Wr.Wb</h5><br>
                <p style="text-align: justify; background-attachment:responsive;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed repellendus quisquam, quo nihil eligendi ab dolore, amet iure possimus corrupti sunt quam laboriosam odit vero exercitationem qui voluptatem, reiciendis iusto!</p>
                <p style="text-align: justify; background-attachment:responsive;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, quod velit aspernatur, cumque minima saepe et autem ratione commodi voluptatum natus dolore pariatur. Nulla, fugiat cumque. Beatae accusamus ab neque!</p> <br>
                <h5 class="font-alt">Wassalamuálaikum Wr.Wb</h5>
              </div>

              <div class="col-sm-6">
                <img src="images/smayani.png" style="display: block; margin: auto;">
              </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="video-box">
                  ...
                  <div class="video-subtitle font-alt">Silahkan Input URL Video</div>
                </div>
              </div>
            </div>
          </div>
