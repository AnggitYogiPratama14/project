...
$query1 = mysqli_query($koneksi, "SELECT judul, isi, tgla, foto FROM tbl_berita");
?>
<!DOCTYPE html>
      ...
      <div class="main">
        ...
        <section class="module" id="news">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">BERITA <br> SD NEGERI KEPUTRAN 06</h2>
              </div>
            </div>
            ...
            <div class="row multi-columns-row post-columns">
                <?php while($row1 = mysqli_fetch_assoc($query1)) : ?>
                  <div class="col-lg-6 col-md-3" align="center">
                    ...
                    <div class="post-thumbnail"><a href="#"><img src="images/berita/<?= $row1['foto'] ?>" alt="Blog-post Thumbnail" width="300px" height="150px"/></a></div>
